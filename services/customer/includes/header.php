...
<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link " href="my_account.php?send_order" ><i class="fa fa-university"></i> My Account</a>
      </li>
      <li class="nav-item">
...
<div class="buttons-navbar clearfix">
  <div class="float-left">
    <h4>Welcome: <span><?php echo $_SESSION['customer_email']; ?></span></h4>
  </div>
  <div class="float-right">
    <a href="my_account.php?send_order" class="btn btn-primary">Send Messages</a>
